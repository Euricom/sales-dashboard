...
const cardVariants = cva("text-white rounded-14", {
  variants: {
    ...
    size: {
      ...
      deal: "h-fit h-[3.75rem] w-full min-w-72 pl-3 pr-1.5 py-1.5",
      row: "",
      employee:
        "h-15 w-15 justify-center items-center bg-white text-black rounded-2xl",
      employeeDragged:
        "h-15 w-20 justify-center items-center bg-white text-black rounded-2xl",
    },
  },
  defaultVariants: {
    variant: "default",
